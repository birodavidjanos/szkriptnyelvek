...
class Bullshit:
    def __init__(self):
        ...
        self.index1=round(random.random()*self.max1)
        self.index2=round(random.random()*self.max2)
        self.index3=round(random.random()*self.max3)
        self.index4=round(random.random()*self.max4)

        self.array1=["Erõforrás-alapú megközelítéssel kell",
...
"vizualizálni"]
        ...
        self.array3 = ["a közösségi normáknak megfelelõ", 
"a decentralizált", 
...
"versenyelõny-forrást"]
    ...
    def getResult(self):
	    ...
	    return self.array1[self.index1] + " " + self.array2[self.index2] + " " + self.array3[self.index3] + " " + self.array4[self.index4] +".";	
